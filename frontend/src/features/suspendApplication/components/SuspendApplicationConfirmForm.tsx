...
import { createSuspendApplication } from '@/features/suspendApplication/api'
...
export function SuspendApplicationConfirmForm({ onBack, workspaceId }: Props) {
  ...
  const [execute, isLoading] = useAsyncSafeAction(async () => {
    await createSuspendApplication(
      {
    ...
    <form onSubmit={onSubmit} className='space-y-10'>
      ...
      <Section>
        ...
        <DatePicker
          ...
          defaultValue={parseDate(preferredStartDate)}
          isDisabled
        />
      </Section>
      ...
      <Section>
        ...
        <DatePicker
          ...
          defaultValue={parseDate(preferredEndDate)}
          isDisabled
        />
      </Section>
